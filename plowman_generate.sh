...
"$VENV_PYTHON" src/png_tools/generate_mask.py png/plowman_tiles.png png
...
"$VENV_PYTHON" src/png_tools/plowman/generate_collision_map.py --tolerance 2px --tile-width 16 --tile-height 16 --scale 3 --objects-sprite png/plowman_map_objects.png png/stage-0001.png collision
